...
public class RoundRobinAlgorithmTest {
    ...
    private final RoundRobinAlgorithm algorithm = new RoundRobinAlgorithm();
    ...
    public void testBasicAllocation() {
        ...
        assertTrue(allocationAgent0.getGoodsList().contains(0)); // Should also get the second round of highest value

        // Check allocation for agent 1
        Allocation allocationAgent1 = allocations.get(1);
        assertTrue(allocationAgent1.getGoodsList().contains(1)); // Should get the remaining goods
    }
